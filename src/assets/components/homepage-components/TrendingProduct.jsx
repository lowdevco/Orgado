...
function TrendingProduct() {
  ...
  return (
    <div className="container my-5">
      <div className="trending-product row g-4">
        ...
        <div className="col-xl-9 col-lg-9 col-md-8 col-12 trending-rt">
          {/* FIX: Added flex-wrap here so the text doesn't stretch the container on mobile */}
          <div className="d-flex align-items-center justify-content-between flex-wrap mb-3 gap-3">
            <div className="mobile-none">
              <h1>You May Missed</h1>
            </div>
            
            {/* Wrapped the links in their own flex container so they behave */}
            <div className="d-flex flex-wrap gap-3 align-items-center">
              <div><h6>View All</h6></div>
              <div><h6>New Arrival</h6></div>
              <div><h6>Best Sale</h6></div>
              <div><h6>Trending</h6></div>
            </div>
