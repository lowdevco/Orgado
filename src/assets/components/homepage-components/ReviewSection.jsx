    ...
    <div className="container my-5">
      <div className="row g-4">
        <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
          <div className="review-tab" id="review-tab-1">
        ...
        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
          <div className="review-tab" id="review-tab-2">
            <div>
              <h6>Orgainic</h6>
              <a href="">Meat & Milk</a>
        ...
        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
          <div className="review-tab" id="review-tab-3">
            <div>
              <h6>Orgainic</h6>
              <a href="">Vegetable</a>
      ...
      <div className="row my-1 g-4 review-bottom-container">
        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
          <div className="review-tab-bottom" id="review-tab-bottom-1">
        ...
        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
          <div className="review-tab-bottom" id="review-tab-bottom-2">
        ...
        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
          <div className="review-tab-bottom" id="review-tab-bottom-3">
            <div className="review-m">
              <div className="d-flex justify-content-between align-items-center">
                <h3>Popular</h3>
                <h6> View All </h6>
        ...
        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
          <div className="review-tab-bottom" id="review-tab-bottom-4">
            <h6>Freshly</h6>
