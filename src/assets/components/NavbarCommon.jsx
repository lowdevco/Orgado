...
function NavbarCommon() {
  return (
        ...
        <div className="container-fluid" id="navbar-id">
          ...
          {/* hidden nav */}
            ...
            <div className="d-flex justify-content-evenly gap-4 navbar-right-icons">
              ...
              {/* burton hide  */}
              <div className="navbar-icon d-none d-md-flex">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
      ...
      >
        ...
        <div className="offcanvas-body">
          <ul className="list-unstyled d-flex flex-column gap-3 mobile-menu-links">
            ...
            <li><a href="#" className="mobile-link">Shop</a></li>
            <li><a href="#" className="mobile-link">Pages</a></li>
            <li><a href="#" className="mobile-link">Blog</a></li>
            <li><a href="#" className="mobile-link">Contact</a></li>
            <li><a href="#" className="mobile-link">Track Order</a></li>
          </ul>
        </div>
        <div className="d-flex ">
    ...
    //       {/* Nav links (Hide on mobile, show on lg+) */}
    //       <div className="d-none d-lg-flex justify-content-evenly gap-5 align-items-center navbar-">
    //         <div className="d-flex ">
    //           <h6>Home</h6>
    //         </div>
    ...
    //       {/* Icons + Hamburger (always visible) */}
    //       <div className="d-flex justify-content-evenly gap-4 navbar-right-icons">
    //         <div className="navbar-icon d-none d-md-flex">
    //           <svg
    //             xmlns="http://www.w3.org/2000/svg"
    ...
    //       <div className="d-flex justify-content-evenly gap-5 align-items-center navbar-">
    //         <div className="d-flex ">
    //           <h6>Home</h6>
    //         </div>
    //         <div className="d-flex">
